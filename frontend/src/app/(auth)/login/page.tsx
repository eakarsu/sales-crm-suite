...
export default function LoginPage() {
  ...
  const onSubmit = async (event: FormEvent) => {
    ...
    setSubmitting(false);
    if (!ok) {
      setError('Use the seeded sales suite demo credentials.');
      return;
    }
  ...
  return (
    <div className="auth-wrap">
      <div className="auth-card">
        <div className="pill">Sales and CRM</div>
        <h1 style={{ marginBottom: 8 }}>Unified sales login</h1>
        <div className="muted">
          One login for accounts, leads, pipeline, outreach, revenue, recruiting, and AI operations.
        </div>
