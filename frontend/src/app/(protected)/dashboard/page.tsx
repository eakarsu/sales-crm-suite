...
export default function DashboardPage() {
  return (
    <UnifiedShell
      ...
      title="Sales and CRM Dashboard"
      subtitle="One merged sales view for CRM, pipeline, outreach, revenue, recruiting, documents, and AI operations."
    >
      ...
      <div className="grid columns-2">
        <div className="card stack">
          ...
          <div className="muted">
            This suite removes project-based navigation and groups shared sales jobs into one surface.
            CRM, outreach, revenue, recruiting, and AI are presented as platform features.
          </div>
