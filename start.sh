...
PORT="${PORT:-3400}"
DB_NAME="${PGDATABASE:-sales_crm_suite}"
DB_HOST="${PGHOST:-127.0.0.1}"

echo "======================================="
echo "      Sales and CRM Suite"
echo "======================================="
echo
...
echo "Starting sales suite frontend on http://localhost:$PORT"
echo "Login: admin@sales-crm.local / admin123"
